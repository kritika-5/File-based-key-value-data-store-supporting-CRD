...
d.create("Apple",56) #to create a key with key_name,value given and with no time-to-live property


d.create("Samsung",96,2500) #to create a key with key_name,value given and with time-to-live property value given(number of seconds)
...
d.create("Apple",75) #it returns an ERROR since the key_name already exists in the database 
